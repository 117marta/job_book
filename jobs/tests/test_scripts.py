...
class TestMonthlyStatus(TestCase):
    ...
    def test_export_csv(self, mock_file):
        ...
        expected_call = [
            (1, last_month_formatted, "waiting", "staking", False),
            (2, last_month_formatted, "waiting", "inventory", False),
            (3, last_month_formatted, "accepted", "inventory", False),
            (4, last_month_formatted, "making_documents", "other", False),
            (6, last_month_formatted, "finished", "staking", False),
            ["Number of jobs:", 5],
            (
                [
                    "waiting",
